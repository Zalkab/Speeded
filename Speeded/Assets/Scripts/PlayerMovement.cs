...
public class PlayerMovement : MonoBehaviour
{
    ...
    private Vector3 gliderOffset = new Vector3(0, 5, 0);
    private Vector3 gliderStartRot;
    private float gliderSpeed = 0.4f;
    private float gliderLift = 0.3f;
    private float gliderLength = 3;
    ...
    void Start()
    {
        ...
        gliderStartRot = glider.localEulerAngles;
        glider.localPosition = gliderStartPos + gliderOffset;
        glider.localEulerAngles = new Vector3(glider.localEulerAngles.x, glider.localEulerAngles.y, -90);
    ...
    void GliderManager()
    {
        if (grounded == false && Input.GetKey(KeyCode.Mouse1))
        {
            StartGliding();
        }
    ...
    private void StartGliding()
    {
        ...
        rb.AddForce(orientation.forward * gliderSpeed, ForceMode.Impulse);
    }
